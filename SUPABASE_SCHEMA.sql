...
-- pino_permisos: solo usuarios autenticados que sean admin pueden leer/actualizar/borrar
-- Los usuarios solo pueden insertar (crear nuevas solicitudes)
-- Las actualizaciones requieren permiso del usuario actual o ser admin

create policy "pino_permisos_read_admin"
...
create policy "pino_permisos_insert_own"
  on public.pino_permisos for insert
  to authenticated
  with check (true);

create policy "pino_permisos_update_admin"
...
create policy "pino_permisos_delete_admin"
