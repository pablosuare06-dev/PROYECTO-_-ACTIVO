...
export default function DashboardPersonas() {
  ...
  return (
    <div className="dashboard-personas-root" style={{ minHeight: "100vh", backgroundColor: "#FFFFFF", fontFamily: "Arial, Helvetica, sans-serif", display: "flex", flexDirection: "column", overflowX: "hidden" }}>
      <style>{`
      ...
      `}</style>
      <div className="dp-scale-wrapper">
        {/* Header */}
        <div style={{ backgroundColor: "#000066", padding: "10px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          />
          <span style={{ color: "#FFFFFF", fontSize: "12px", whiteSpace: "nowrap" }}>RIF: J-08006622-7</span>
        </div>
        ...
        <div style={{ backgroundColor: "#f0f0f0", borderBottom: "1px solid #d0d0d0", padding: "8px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <span style={{ color: "#0000cc", fontSize: "14px", fontWeight: 600 }}>Personas</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{ textAlign: "right", lineHeight: 1.3 }}>
              <div style={{ fontSize: "11px", color: "#333333", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "4px" }}>
                ...
                Sr(a) CRISTINA DE JESUS GUATARAMA GARCIA
              </div>
              <div style={{ fontSize: "10px", color: "#666666", display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "4px" }}>
                ...
                Última conexión: 04/07/2026 10:58am
              </div>
            </div>
            <button
              onClick={handleSalir}
        ...
        <div style={{ backgroundColor: "#FFFFFF", borderTop: "1px solid #ccc", padding: "10px 24px", textAlign: "center" }}>
          <p style={{ fontSize: "11px", color: "#000066", margin: 0 }}>
            © Copyright 2026 Banco Activo, C.A. Banco Universal. RIF: J-08006622-7. Todos los derechos reservados. La información mostrada en esta página, es de carácter Confidencial
          </p>
        </div>
      </div>{/* end dp-scale-wrapper */}
